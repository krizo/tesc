...
class DeliveriesControllerTest < ActionController::TestCase
  ...
  test "should create delivery" do
    assert_difference('Delivery.count') do
      post :create, delivery: { amount: @delivery.amount, comments: @delivery.comments, date: @delivery.date, instructions: @delivery.instructions }
    end
  ...
  test "should update delivery" do
    patch :update, id: @delivery, delivery: { amount: @delivery.amount, comments: @delivery.comments, date: @delivery.date, instructions: @delivery.instructions }
    assert_redirected_to delivery_path(assigns(:delivery))
  end
